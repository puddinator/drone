...
#ifdef QUADCOPTER
    esc_1 = throttle - pid_output_pitch + pid_output_roll + pid_output_yaw - pid_output_alt; //Calculate the pulse for esc 1 (front-right - CCW)
    esc_2 = throttle + pid_output_pitch + pid_output_roll - pid_output_yaw - pid_output_alt; //Calculate the pulse for esc 2 (rear-right - CW)
    esc_3 = throttle + pid_output_pitch - pid_output_roll + pid_output_yaw - pid_output_alt; //Calculate the pulse for esc 3 (rear-left - CCW)
    esc_4 = throttle - pid_output_pitch - pid_output_roll - pid_output_yaw - pid_output_alt; //Calculate the pulse for esc 4 (front-left - CW)
#endif
